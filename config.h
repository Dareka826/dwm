...
static const char *tmux_attachcmd[]  = { "alacritty", "-e", "tmux", "attach", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_Return, spawn,          {.v = tmuxcmd } },
	{ MODKEY|ShiftMask|ControlMask, XK_a,      spawn,          {.v = tmux_attachcmd } },
	...
	{ MODKEY|ControlMask,           XK_Up,     spawn,          {.v = increasevol } },
